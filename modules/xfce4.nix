...

{
  ...
  environment.systemPackages = with pkgs; [
    xfce.xfce4-whiskermenu-plugin xfce.xfce4-docklike-plugin xfce.xfce4-panel-profiles xfce.xfce4-pulseaudio-plugin alacarte pantheon.sideload pantheon.appcenter simple-cursors
  ];
